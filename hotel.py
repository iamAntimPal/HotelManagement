...
class Login_window:
     def __init__(self,root) :
          ...
          btnAdd=Button(self.root,text="Login",font=("arial",12,"bold"),command=self.validate_login,bg="skyblue",fg="white")
          btnAdd.place(x=607,y=468,width=345,height=55)
          
          #ADD USER
          
          Add_User_id=Label(self.root,text="Not registered?",font=("arial",12,"bold"),background="white",fg="gray",padx=2,pady=6)
          Add_User_id.place(x=620,y=535)
          
          Add_btnAdd=Button(self.root,text="create an account",command=self.Add_user,fg="skyblue",font=("arial",12,"bold"))
          Add_btnAdd.place(x=750,y=535)
