...
class HotelManagementSystem:
     def __init__(self,root) :
          ...
          report_btn=Button(btn_frame,text="REPORT",command=self.Report_win,width=20,font=("times new roman",14,"bold"),justify="center",bg="black",fg="gold",bd=4,cursor="hand1")
