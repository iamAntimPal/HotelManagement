...
class Roombooking :
 ...
 #========================labels and entry====================
     ...
     #fetch data button
          ...
          txtMeal=ttk.Combobox(labelframeleft,width=29,font=("arial",13,"bold"),textvariable=self.var_meal,justify=CENTER,state="readonly")
          txtMeal["value"]=("Breakfast","Lunch","Dinner","Water","Juice","Fast Food")
          txtMeal.current(0)
...
#============================== Bill button=========================================         
          ...
          btnAdd=Button(labelframeleft,text="BILL",command=self.calculate_bill,font=("arial",12,"bold"),bg="black",fg="gold",width=9)
...
#==============================button=========================================
          ...
          btnAdd=Button(labelframeleft,text="ADD",command=self.add_customer_data,font=("arial",12,"bold"),bg="black",fg="gold",width=9)
          btnAdd.grid(row=0,column=0,padx=1)

          btnUpdate=Button(labelframeleft,text="UPDATE",command=self.update,font=("arial",12,"bold"),bg="black",fg="gold",width=9)
          ...
          btnReset=Button(labelframeleft,text="RESET",command=self.reset,font=("arial",12,"bold"),bg="black",fg="gold",width=9)
